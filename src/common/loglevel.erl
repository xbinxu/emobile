...
-module(loglevel). %% copy from ejabberd_loglevel
...
set(Loglevel) when is_integer(Loglevel) ->
    try
        {Mod,Code} = dynamic_compile:from_string(emobile_logger_src(Loglevel)),
...
%% very efficient code.
emobile_logger_src(Loglevel) ->
    L = integer_to_list(Loglevel),
    "-module(em_error_logger). %% copy from ejabberd_logger
    -author('mickael.remond@process-one.net').
